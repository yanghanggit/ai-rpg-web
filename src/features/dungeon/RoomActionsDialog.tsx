...
export default function RoomActionsDialog({
  ...
  return (
    <Modal title="副本操作" onClose={onClose}>
      <ul className="action-list">
        ...
        <li>
          <button
            type="button"
            className={narrative.unread > 0 ? "count-button count-button--unread" : undefined}
          ...
          {narrative.unread > 0 ? <span className="badge">{narrative.unread} 条新事件</span> : null}
        </li>
